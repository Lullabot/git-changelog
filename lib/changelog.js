...
class Changelog {
        ...
        for (let i in allTasks) {
            if (allTasks[i].hasOwnProperty('questions')) {
                allTasks[i].questions.forEach(question => {
                    ...
                    let defaultVal = this._getOption(question.name);
     ...
     */
    getJiraProjectKey() {
        return this._getOption('jiraProjectKey');
    }
     ...
     */
    getReleaseTag() {
        return this._getOption('releaseTag');
    }
     ...
     */
    getReleaseName() {
        return this._getOption('releaseName');
    }
     ...
     */
    getGroupingField() {
        return this._getOption('groupByField');
    }
    ...
    async getJiraIssue(issueKey) {
        ...
        const extraFields = this._getOption('jiraFields') || [];
